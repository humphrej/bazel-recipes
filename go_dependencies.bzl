...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:PCaQSqG0HiCgpekchPrHO9AEc5ZUaAclOUp9T3RSKoQ=",
        version = "v0.19.19",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AkHXYBEOoyvocl8YhzoStATRnto5OH1PY4Rj78I5Cuc=",
        version = "v0.3.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:S7T6cx5o2OqmxdHaXLH1ZeD1SbI8jBznyYE9Ec0RCQ8=",
        version = "v1.6.4",
    )
    go_repository(
