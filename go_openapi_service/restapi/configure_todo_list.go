...
import (
	...
	"humphrej/go_openapi_service/models"
	"net/http"
	"sync"
	"sync/atomic"
	...
	"humphrej/go_openapi_service/restapi/operations"
	"humphrej/go_openapi_service/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../service --name TodoList --spec ../swagger.yml
